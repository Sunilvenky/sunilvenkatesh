...
export default function NoteDetail() {
  ...
  const notes: Record<string, any> = {
    "1": {
      ...
      date: "January 2026",
      readTime: "7 min",
      content: `Depression doesn't announce itself as pain.
...
Just honesty.`,
    ...
    "2": {
      ...
      date: "December 2025",
      readTime: "6 min",
      content: `When you were a child, you didn't try to be happy.
...
And that changes everything.`,
    ...
    "3": {
      ...
      date: "November 2025",
      readTime: "7 min",
      content: `At 14,000 feet, urgency doesn't survive. The air edits it out.
...
Sometimes the fastest way forward is learning how to stand still without needing to escape yourself.`,
    ...
    "4": {
      ...
      date: "October 2025",
      readTime: "6 min",
      content: `I started as a momentum trader because it felt like winning.
...
The market didn't change. My relationship with it did.`,
    ...
    "5": {
      ...
      date: "September 2025",
      readTime: "7 min",
      content: `Death is a very fundamental question. Actually, death is closer to us than the statistics we read about it.
...
There is no time like the present moment. Because the present moment is the only moment where life actually happens.`,
    ...
    "6": {
      ...
      date: "August 2025",
      readTime: "6 min",
      content: `(As approved by society)
...
It just doesn't shout.`,
    ...
    "7": {
      ...
      date: "July 2025",
      readTime: "8 min",
      content: `People ask me why I go to the mountains.
...
stop trying to explain it.`,
    ...
    "8": {
      ...
      date: "June 2025",
      readTime: "6 min",
      content: `At some point, most of us wake up chasing a life we never consciously chose.
...
always feels heavier than picking it up.`,
  ...
  const note = notes[noteId as string] || notes["1"]
  const allIds = Object.keys(notes)
  const currentIndex = allIds.indexOf(noteId as string)
    ...
    <main className="min-h-screen bg-background text-foreground">
      ...
      <section className="py-16 px-4 border-t border-border/30">
        <div className="max-w-2xl mx-auto flex justify-between items-center">
          {prevId ? (
            <Link href={`/notes/${prevId}`} className="text-muted-foreground hover:text-foreground transition-colors">
              ← Previous
            </Link>
          ) : <div />}
          {nextId ? (
            <Link href={`/notes/${nextId}`} className="text-muted-foreground hover:text-foreground transition-colors">
              Next →
            </Link>
          ) : <div />}
        </div>
